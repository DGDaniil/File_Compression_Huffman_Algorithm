...
int main(int argc, char** argv){
    ...
    if(argc <= 2){
        ...
        string file = argv[1];
        string ext = compressed_extension;
        replaceExt(file,ext);
    ...
    fp = fopen(argv[1],"rb");
    if(fp == NULL){
        cout<<"Error, Input file does not exists, Check the file name\n";
        return -1;
    }

    cout<<"Initiating the compression sequence.................\n";
    ...
    cout<<"Constructing Huffman-Tree....................\n";
    makeTree();
    cout<<"Assigning codewords..........................\n";
